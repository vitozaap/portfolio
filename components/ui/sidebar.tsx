...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn(
        "-mx-2 w-auto border bg-sidebar-border data-horizontal:w-[calc(100%+(--spacing(4)))]",
        className
      )}
      {...props}
    />
